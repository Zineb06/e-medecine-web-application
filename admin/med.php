...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <a href="med.php"><li id="active"><i class="fa fa-notes-medical"></i>&nbsp;<span>Médecins</span> </li></a>
            ...
            <div class="content-2">
                <div class="new-students">
                    <div class="title">
                       ...
                       <a href="signup_med_form.php" class="btn btn-success">Ajouter Médecin</a>
                    </div>
                    <table>
                        <tr>
                            <th>Profile</th>
             ...
             <?php 
                             $sql="select *  from medecin order by inp desc";
                             ...
                             if($result){
                                ...
                                <td>
                                   ...
                                   <button class="btn btn-danger "><a class="text-light" href="delete.php?inp='.$inp.'"><i class="fa fa-trash"></i></a></button>
                               </td>
                                </tr>';
                            }}
