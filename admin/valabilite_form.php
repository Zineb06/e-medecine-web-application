...
<?php
$sql="insert into valabilite (inp,temps_valable) values('$inp','$temps')";
...
<body>
      <a href="disp.php" class="btn btn-info" style=" background:lightgreen; color:#000; margin-left:10px">Liste des horaires</a>
