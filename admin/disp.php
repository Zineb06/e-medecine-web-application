...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <a href="disp.php"><li id="active"><i class="fa fa-clock"></i>&nbsp;<span>Disponibilités</span> </li></a>
           <br><br><br><br>
            ...
            <div class="content-2">
                <div class="new-students">
                    <div class="title">
                      ...
                      <a href="valabilite_form.php" class="btn btn-success">Ajouter 
                         </a>
                    </div>
                    <table>
                        <tr>
              ...
              <?php 
                             $sql="select m.*, v.* from valabilite v, medecin m where m.inp=v.inp order by m.nom_complet ";
                             ...
                             if($result){
                                ...
                                <td>'.$temps.'</td>
                                <td>
                                   <button class="btn btn-danger "><a class="text-light" href="delete_valabilite.php?id='.$row['id'].'"><i class="fa fa-trash"></i></a></button> &nbsp&nbsp
                                   <button class="btn btn-warning "><a class="text-light" href="update_valabilite.php?id='.$row['id'].'"><i class="fa fa-pen"></i></a></button>
                               </td>
                                </tr>';
                            }}
