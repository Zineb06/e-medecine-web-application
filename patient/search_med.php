...
$requete= "select nom_complet, specialite, img from medecin where nom_complet='$search_name' ";
    ...
    <div class="box-container">
        <div class="flip">
            <div class="box">
                ...
                <div class="box-back">
                    <a href="med-profil.php?inp=<?php $row['inp'];?>" class="btn-med">Voir Profil</a>
                    <a href="rdv-form.php?inp=<?php $row['inp'];?>" class="btn-med">Prendre Un RDV</a>
                    <a href="chatbox.php?inp=<?php $row['inp'];?>" class="btn-med">Contacter</a>
                </div>
            </div>
        </div>
    </div>
...
<?php 
  }else{ header("location:notfound.html");}
 ?>
