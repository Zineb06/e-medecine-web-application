...
$etat="en demande";
$etat2="annulé";
$req="select r.*,p.*  from rdv r, patient p  where r.cin=p.cin and inp='$inp' and etat != '$etat' and etat != '$etat2' order by date_rdv";
...
<head>
    ...
    <style>.table .fa{  margin-left: 15px; }</style>
</head>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid"
                                ...
                                <?php while($row=mysqli_fetch_array($res)){ ?>
                                        <tr>
                                            ...
                                            <td><?php echo date($row['date_rdv']); ?></td>
                                            <td><?php echo $row['temps']; ?></td>
                                            <td>
                                                <?php if($row['etat']=="confirmé"){?>
                                                <b style="color: green"><?php echo $row['etat'];?>
                                                 <a href="done.php?id=<?php echo $row['id']; ?>";><i class="fa fa-check"></i></a>
                                                <?php }?></b>

                                                <?php if ($row['etat']=="terminé"){ ?>
                                                    <b style="color:black"><?php echo $row['etat'];?>
                                                    <?php }?></b>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <a href="ord.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-warning">Ajouter</button></a>
                                            </td>
                                        </tr>
                                 <?php }  ?>
